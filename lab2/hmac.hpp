...
static
void
kdf2(const uint8_t (&S)[N], const uint8_t (&T)[Tl], const uint8_t (&Zi_1)[M], size_t C, const std::string& P, const std::string& U,/* const size_t A, const size_t L*/ uint8_t (&dest)[L]);
