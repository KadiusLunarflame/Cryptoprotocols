//
// Created by kadius on 29.06.23.
//

#ifndef TESTPROJECT_CRC_HPP
#define TESTPROJECT_CRC_HPP
...
public:
    ...
    template <size_t N>
    void input(const uint8_t (&message_array)[N]){
